@ECHO OFF
TITLE SocialIsolationSimulator
...
CD SocialIsolationSimulator

REM Start the Model
START javaw -XX:+IgnoreUnrecognizedVMOptions --add-modules=ALL-SYSTEM --add-exports=java.base/jdk.internal.ref=ALL-UNNAMED -cp %CP% repast.simphony.runtime.RepastMain ./SocialIsolationSimulator.rs
