...
public class Displacement {
	public Displacement(Person people, double t) {
		stay=true;
		this.people = people;
		finish = t;
		TimeStaying =0;
	...
	public Displacement(Person people, Position newPosition) {
		this.people = people;
		this.newPosition = newPosition;
		move = direction();
		people.State=true;
		Position oldPosition = DisplaySpreadHelper.matrix[people.x][people.y];
	...
	public boolean walk() {
		...
		if(people.x== newPosition.x && people.y == newPosition.y) {
			people.State=false;
			Position newPosition = DisplaySpreadHelper.matrix[people.x][people.y];
